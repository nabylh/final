...
router.put('/comments/:commentId', withAuth, updateComment); // Mettre à jour un commentaire (authentifié si nécessaire)
router.delete('/comments/:commentId', withAuth, deleteComment); // Supprimer un commentaire (authentifié si nécessaire)
